...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" to="/" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Picoritamy</span>
			</Link>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<Link rel="noopener noreferrer" to="/Gallery">Gallery</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/services">Services</Link>
					</li>
					<li>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2022 Picoritamy . All rights reserved.</div>
</footer>
        </div>
    );
};
