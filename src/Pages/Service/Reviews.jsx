  ...
  return (
	...
	<div className="container mx-auto">
		<div className="flex flex-col lg:flex-row items-center justify-center">
			<h2 className="text-center text-3xl tracking-tighter font-bold"> Customer Review
      ...
      <div className="mainParent mt-10">
        <div className="left">
          <div className="container flex justify-start flex-col w-full max-w-lg p-6 divide-y rounded-md  bg-gray-100">
